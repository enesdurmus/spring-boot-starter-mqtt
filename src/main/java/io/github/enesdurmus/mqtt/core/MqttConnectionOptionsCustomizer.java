...
/**
 * Callback for tuning the Paho connection options beyond what the {@code mqtt.*} properties
 * expose — TLS socket factories, custom WebSocket headers, authentication data, and so on.
 *
