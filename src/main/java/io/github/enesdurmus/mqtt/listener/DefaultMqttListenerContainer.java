...
public class DefaultMqttListenerContainer implements MqttListenerContainer {
    ...
    public DefaultMqttListenerContainer(MqttListenerEndpoint endpoint,
        ...
        Assert.notNull(subscriptionManager, "subscriptionManager must not be null");
        Assert.notNull(taskExecutor, "taskExecutor must not be null");
        Assert.notNull(defaultErrorHandler, "defaultErrorHandler must not be null");
